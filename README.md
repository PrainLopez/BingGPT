...
(2023.8.3)今日发现微软更新了ip检测，解决方法为更新X-Forwarded-For字段为“可靠”的IP地址（修改报头该字段代码位于main.js line287) ——本人从梯子上扒了一个日本家宽IP，实测正常，可能涉敏故没有push，闲得无事会考虑更新成JSON配置文件（自己凭脑子挖的坑凭什么填）
